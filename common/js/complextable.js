$(document).ready(function(){
	...
	$(".complex_form .expand .show a").click(function(){ 
		...
		$(".complex_form caption").css({background:"#f2f1ef 5px 50% url('common/images/icn_disclosure_open.gif') no-repeat",borderBottom:"1px solid #ccc"});
	});
	$(".complex_form .expand .collapse a").click(function(){ 
		$(".complex_form table tbody, .complex_form table tbody tr, .bursary").css({position:"absolute", left:"-999em", top:"-999em"});
		$(".complex_form caption").css({background:"#f2f1ef 5px 50% url('common/images/icn_disclosure_closed.gif') no-repeat", borderBottom:"none"});
	});
	...
	$(".complex_form caption").css({cursor:"pointer", paddingLeft:"17px", background:"#f2f1ef 5px 50% url('common/images/icn_disclosure_closed.gif') no-repeat", borderTop:"1px solid #ccc"}).toggle(
		 function () {
			$(this).css({background:"#f2f1ef 5px 50% url('common/images/icn_disclosure_open.gif') no-repeat",borderBottom:"1px solid #ccc"});
		 ...
		 function () {
			$(this).css({background:"#f2f1ef 5px 50% url('common/images/icn_disclosure_closed.gif') no-repeat", borderBottom:"none"});

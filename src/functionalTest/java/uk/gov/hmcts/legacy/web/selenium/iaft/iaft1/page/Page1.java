...
public class Page1 extends AbstractIAFTPage implements IaftPage {
	...
	public static final String LEGAL_AID_FUNDING_XPATH = "//input[@name='qb_lsc' and @value='LSC']";
	...
	public static final String FAMILY_MEMBER_REF_1 = "prn1";

	public static final String FAMILY_MEMBER_REF_2 = "prn2";

	public static final String FAMILY_MEMBER_REF_3 = "prn3";

	public static final String FAMILY_MEMBER_REF_4 = "prn4";

	@Override
	public void execute() {
		logger.info("Executing IAFT1 Step 1");
		...
		if (fieldLength == 20) {
			...
			val = fields[4];
			if (val.equals(NO_FUNDING_XPATH)) {
			...
			val = fields[6];
			if (val.equals(FAMILY_MEMBER_YES_XPATH)) {
			...
			val = fields[9];
			if (null != val) {
				findByNameAndEnterText(FAMILY_MEMBER_REF_1, val);
			}
			...
			val = fields[12];
			if (null != val) {
				findByNameAndEnterText(FAMILY_MEMBER_REF_2, val);
			}
			...
			val = fields[15];
			if (null != val) {
				findByNameAndEnterText(FAMILY_MEMBER_REF_3, val);
			}
			...
			val = fields[18];
			if (null != val) {
				findByNameAndEnterText(FAMILY_MEMBER_REF_4, val);
			}
			...
			logger.info("Page1 not initialised with correct number of fields. Expected 20 was " + fieldLength);
		}
	}

...
public class Page7 extends AbstractIAFTPage implements IaftPage {
    ...
    public static final String FAX_NAME = "s5f";

    public static final String EMAIL_NAME = "s5g";

    public static final String LEGAL_REFERENCE_NUMBER_NAME = "s5h";

    public static final String AREA_NAME = "s5i";

    public static final String REPRESENTATIVE_NAME = "rep_sign";

    @Override
    public void execute() {
        logger.info("Executing IAFT2 Step 7");
        ...
        if (fieldLength == 17) {
            ...
            val = fields[14];
            if (null != val && val.equals(APPELLANT_DECLARATION_XPATH)) {
                findByXPathAndClick(APPELLANT_DECLARATION_XPATH);
            } else if (null != val && val.equals(REPRESENTATIVE_DECLARATION_XPATH)) {
            ...
            logger.info("Page7 not initialised with correct number of fields. Expected 17 was " + fieldLength);
        }

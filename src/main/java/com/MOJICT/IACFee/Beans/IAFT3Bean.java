...
public class IAFT3Bean extends ActionForm implements IAFTBean {
	/**
	 * log4j logging solution
	 */
	static Logger logger = Logger.getLogger(IAFT3Bean.class);
	...
	private String s2f;
	private Date s2g;
	private int s2g_service_day;
	private int s2g_service_month;
	private int s2g_service_year;
	...
	public void setS2g(Date s2g) {
		this.s2g = s2g;
	}

	public int getS2g_service_day() {
		return s2g_service_day;
	}

	public void setS2g_service_day(int s2g_service_day) {
		this.s2g_service_day = s2g_service_day;
	}

	public int getS2g_service_month() {
		return s2g_service_month;
	}

	public void setS2g_service_month(int s2g_service_month) {
		this.s2g_service_month = s2g_service_month;
	}

	public int getS2g_service_year() {
		return s2g_service_year;
	}

	public void setS2g_service_year(int s2g_service_year) {
		this.s2g_service_year = s2g_service_year;
	}

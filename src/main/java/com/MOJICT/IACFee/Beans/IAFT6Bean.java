...
public class IAFT6Bean extends ActionForm implements IAFTBean {
	/**
	...
	private Date s2f;
	private int s2f_day;
	private int s2f_month;
	private int s2f_year;
	...
	public int getS2f_day() {
		return s2f_day;
	}

	public void setS2f_day(int s2f_day) {
		this.s2f_day = s2f_day;
	}

	public int getS2f_month() {
		return s2f_month;
	}

	public void setS2f_month(int s2f_month) {
		this.s2f_month = s2f_month;
	}

	public int getS2f_year() {
		return s2f_year;
	}

	public void setS2f_year(int s2f_year) {
		this.s2f_year = s2f_year;
	}

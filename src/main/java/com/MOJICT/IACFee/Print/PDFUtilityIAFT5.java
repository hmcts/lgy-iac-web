...
public class PDFUtilityIAFT5 extends Action {
	/**
	 * log4j logging solution
	 */
	static Logger logger = Logger.getLogger(PDFUtilityIAFT5.class);
	...
	public static ByteArrayOutputStream GenerateIAFT5PDF(String path, boolean paymentStatus, IAFT5Bean frm)
			throws IOException, DocumentException {

		logger.info("PDFUtilityIAFT5.GenerateIAFT5PDF");

		try {
			String template = "";

			if (paymentStatus == true)
				template = "templates/IAFT5-online.pdf";
			else
				template = "templates/IAFT5-online.pdf";
			...
			try {
				...
				if (frm.getQb_lsc().equals("humanrights")) {
					form.setField("qb_rdo", "5");
					form.setField("qb_LAR", frm.getQb_LAR());
				}
				
				if (frm.getQb_lsc().equals("No")) {
					form.setField("qb_rdo", "6");
...
*/				
				...
				logger.error("PDFUtilityIAFT5.GenerateIAFT5PDF - ", ex);
			}

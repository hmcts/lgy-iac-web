...
public class PDFUtilityIAFT5 extends Action {
	...
	public static ByteArrayOutputStream GenerateIAFT5PDF(String path, String paymentStatus, IAFT5Bean frm)
			throws IOException, DocumentException {

		try {
			logger.info("PDFUtilityIAFT5.GenerateIAFT5PDF - Security Token: " + frm.getSecuritytoken());
			String template = "";
			...
			try {
				...
				if (frm.getQb_lsc().equals("helpwithfees")) {
					form.setField("qb_rdo", "7");
					form.setField("qb_LAR", frm.getQb_LAR());
				}

...
public class PDFUtilityIAFT6 extends Action {
	...
	public static ByteArrayOutputStream GenerateIAFT6PDF(String path, String paymentStatus, IAFT6Bean frm)
			throws IOException, DocumentException {

		try {
			logger.info("PDFUtilityIAFT6.GenerateIAFT6PDF - Security Token: " + frm.getSecuritytoken());
			String template = "";

...
public class PDFUtilityIAFT7 extends Action {
	...
	public static ByteArrayOutputStream GenerateIAFT7PDF(String path, String paymentStatus, IAFT7Bean frm)
			throws IOException, DocumentException {

		try {
			logger.info("PDFUtilityIAFT7.GenerateIAFT7PDF - Security Token: " + frm.getSecuritytoken());
			String template = "";

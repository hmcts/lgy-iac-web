...
/**
 * The Class QueryBuilder5.
 */
public class QueryBuilder5 extends GenericQueryBuilder implements QueryBuilder5Properties {
	
	/** log4j logging solution. */
	static Logger logger = Logger.getLogger(QueryBuilder5.class);
	 ...
	 *             the sQL exception
	 */
	private IAFT5Bean populateIAFT5Bean(IAFT5Bean bean, HttpServletRequest req, String security_token, Connection conn)
			throws SQLException {
...
//		Connection conn = null;
	 ...
	 */
	public static IAFT5Bean retrieve(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {
		Connection conn = null;
		IAFT5Bean bean = new IAFT5Bean();
		QueryBuilder5 qBuilder = new QueryBuilder5();
		try {
			
			DBConnection dbconnection = new DBConnection();
			conn=dbconnection.getConnection();
 
			bean = qBuilder.populateIAFT5Bean(bean, req, security_token,conn);
		} catch (Exception e) {
			logger.error("QueryBuilder5.retrieve", e);
			return bean;
		}finally {
			try {
				
				QueryBuilder5.closeConnection(conn);
				logger.debug("\t\tMethod: IAFT5_2 Status:Save End");
			} catch (SQLException sqle) {
				logger.error("QueryBuilder5.retrieve", sqle);
			}
		}
		return bean;
	}
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT5_1(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {
		Connection conn = null;
		IAFT5Bean bean = new IAFT5Bean();
		...
		if (action.equals("retrieve")) {
			return QueryBuilder5.retrieve(frm, action, datasource, security_token, req);
		}
			...
			try {
				...
				if (!save.equals("update")) {
					...
					stmturn.setInt(1, SecurityToken.generateSubmissionURN(submission_urn));
				...
				{
					IAFT5Bean iaf=(IAFT5Bean)QueryBuilder5.retrieve(frm, action, datasource, security_token, req);
					if (frm.getQb_lsc().equals("No")) {
				...
				if (save.equals("update")) {
					...
					// bean = QueryBuilder5.retrieve(frm, action, datasource,
					// security_token, req);
					IAFT5Bean iaf=(IAFT5Bean)QueryBuilder5.retrieve(frm, action, datasource, security_token, req);
					...
					stmt1.execute();
					logger.debug("\t\tMethod: IAFT5_1 Status:Update End");
					return QueryBuilder5.retrieve(frm, action, datasource, req.getSession().getAttribute("token1")
							.toString(), req);
				} else {
				...
				logger.error("QueryBuilder5.IAFT5_1", e);
				return bean;
			}finally{
				try{
				QueryBuilder5.closeConnection(conn);
				}catch (Exception r) {
					logger.error("QueryBuilder5.IAFT5_1", r);
				}
			}
		}
		logger.debug("\t\tMethod: IAFT5_1 Status:Save End");
		return bean;
	}
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT5_2(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {
		Connection conn = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
		...
		if (action == "retrieve") {
			try {
				...
				logger.error("QueryBuilder5.IAFT5_2", e);
				return bean;
			} finally {
				try {
					QueryBuilder5.closeResultSet(rs);
					QueryBuilder5.closePreparedStatement(stmt);
					QueryBuilder5.closeConnection(conn);
				} catch (SQLException sqle) {
					logger.error("QueryBuilder5.IAFT5_2", sqle);
				}
			}
		}
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT5_3(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {

		logger.debug("\t\tMethod: IAFT5_3 Status: Start");
		Connection conn = null;
		PreparedStatement stmt = null;
		PreparedStatement stmt1 = null;
		ResultSet rs = null;
			...
			IAFT5Bean bean = new IAFT5Bean();
			IAFT5Bean bean_amount = new IAFT5Bean();
			...
			if (action == "retrieve") {
				try {
					...
					logger.error("QueryBuilder5.IAFT5_3", e);
					return bean;
				}finally {
					try {
						QueryBuilder5.closeResultSet(rs);
						...
						logger.error("QueryBuilder5.IAFT5_3", sqle);
					}
				}
			}
			...
			if (action == "save") {
				try {
					...
					stmt.setDate(
							7,
							frm.getS2i());
					stmt.setString(8, frm.getS2hoan());
					frm.setS2j(dateconverter.convertdate(frm.getS2j_service_day(), frm.getS2j_service_month(),
							frm.getS2j_service_year()));
					stmt.setDate(9,frm.getS2j());
					stmt.setString(10, frm.getS2k());
					
					stmt.setString(11, security_token);

					stmt.executeUpdate();
					bean_amount = QueryBuilder5.retrieve(frm, action, datasource, security_token, req);
					closeResultSet(rs);
					closePreparedStatement(stmt);
					...
					try {
						QueryBuilder5.closeResultSet(rs);
						QueryBuilder5.closePreparedStatement(stmt);
						QueryBuilder5.closePreparedStatement(stmt1);
						QueryBuilder5.closeConnection(conn);
						logger.debug("\t\tMethod: IAFT5_3 Status: End");
					} catch (SQLException sqle) {
						logger.error("QueryBuilder5.IAFT5_3", sqle);
					}
				}
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT5_4(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {

		logger.debug("\t\tMethod: IAFT5_4 Status: Start");
		Connection conn = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
		IAFT5Bean bean = new IAFT5Bean();
			...
			if (action == "retrieve") {
				try {
					...
					logger.error("QueryBuilder5.IAFT5_4", e);
					return bean;
				}finally {
					try {
						QueryBuilder5.closeResultSet(rs);
						...
						logger.error("QueryBuilder5.IAFT5_4", sqle);
					}
				}
			}
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT5_5(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {

		logger.debug("\t\tMethod: IAFT5_5 Status: Start");
		IAFT5Bean bean = new IAFT5Bean();
		PreparedStatement stmt = null;
		ResultSet rs = null;
		Connection conn = null;
		if (action == "retrieve") {
			try {
				...
				logger.error("QueryBuilder5.IAFT5_5", e);
				return bean;
			} finally {
				try {
					QueryBuilder5.closeResultSet(rs);
					QueryBuilder5.closePreparedStatement(stmt);
					QueryBuilder5.closeConnection(conn);
					logger.debug("\t\tMethod: IAFT5_5 Status: End");
				} catch (SQLException sqle) {
					logger.error("QueryBuilder5.IAFT5_5", sqle);
				}
			}
		}
		...
		if (action == "save") {
			...
			try {
				...
				try {
					QueryBuilder5.closeResultSet(rs);
					QueryBuilder5.closePreparedStatement(stmt1);
					QueryBuilder5.closePreparedStatement(stmt2);
					QueryBuilder5.closePreparedStatement(stmt3);
					QueryBuilder5.closeConnection(conn);
					logger.debug("\t\tMethod: IAFT5_6 Status: End");
				} catch (SQLException sqle) {
					logger.error("QueryBuilder5.IAFT5_5", sqle);
				}
			}
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT5_6(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {

		logger.debug("\t\tMethod: IAFT5_6 Status: Start");
		Connection conn = null;
		IAFT5Bean bean = new IAFT5Bean();
		ResultSet rs = null;
		PreparedStatement stmt = null;
		if (action == "retrieve") {
			try {
				...
				logger.error("QueryBuilder5.IAFT5_6", e);
				return bean;
			} finally {
				try {
					QueryBuilder5.closeResultSet(rs);
					...
					logger.error("QueryBuilder5.IAFT5_6", sqle);
				}
			}
		}
		...
		if (action == "save") {
			...
			try {
				...
				try {
					QueryBuilder5.closePreparedStatement(stmt4);
					QueryBuilder5.closePreparedStatement(stmt5);
					QueryBuilder5.closePreparedStatement(stmt6);
					QueryBuilder5.closePreparedStatement(stmt7);
					QueryBuilder5.closeConnection(conn);
					logger.debug("\t\tMethod: IAFT5_6 Status: End");
				} catch (SQLException sqle) {
					logger.error("QueryBuilder5.IAFT5_6", sqle);
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT5_7(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {
		Connection conn = null;
		logger.debug("\t\tMethod: IAFT5_7 Status: Start");
		...
		if (action == "retrieve") {
			...
			try {
				...
				logger.error("QueryBuilder5.IAFT5_7", e);
				return bean;
			} finally {
				try {
					QueryBuilder5.closeResultSet(rs);
					QueryBuilder5.closePreparedStatement(stmt);
					QueryBuilder5.closeConnection(conn);
					logger.debug("\t\tMethod: IAFT5_7 Status: End");
				} catch (SQLException sqle) {
					logger.error("QueryBuilder5.IAFT5_7", sqle);
				}
			}
		}
		...
		if (action == "save") {
			...
			try {
				...
				try {
					QueryBuilder5.closePreparedStatement(stmt8);
					QueryBuilder5.closePreparedStatement(stmt9);
					QueryBuilder5.closeConnection(conn);
					logger.debug("\t\tMethod: IAFT5_7 Status: End");
				} catch (SQLException sqle) {
					logger.error("QueryBuilder5.IAFT5_7", sqle);
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT5_8(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {
		Connection conn = null;
		logger.debug("\t\tMethod: IAFT5_8 Status: Start");
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
			IAFT5Bean bean = new IAFT5Bean();
			if (action == "retrieve") {
				try {
					...
					logger.error("QueryBuilder5.IAFT5_8", e);
					return bean;
				}
			}
			...
			try {
				QueryBuilder5.closeResultSet(rs);
				QueryBuilder5.closePreparedStatement(stmt);
				logger.debug("\t\tMethod: IAFT5_8 Status: End");
				QueryBuilder5.closeConnection(conn);
			} catch (SQLException sqle) {
				logger.error("QueryBuilder5.IAFT5_8", sqle);
			}
		}
	}
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT5_9(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {
		Connection conn = null;
		logger.debug("\t\tMethod: IAFT5_9 Status: Start");
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
			IAFT5Bean bean = new IAFT5Bean();
			if (action == "retrieve") {
				try {
					...
					logger.error("QueryBuilder5.IAFT5_9", e);
					return bean;
				}finally {
					try {
						QueryBuilder5.closeResultSet(rs);
						...
						logger.error("QueryBuilder5.IAFT5_9", sqle);
					}
				}
			}
			...
			if (action == "save") {
				...
				try {
					...
					stmt.setString(4, security_token);
					stmt.executeUpdate();
					logger.debug("\t\tMethod: IAFT5_9 Status:Save End");
					return QueryBuilder5.retrieve(frm, action, datasource, security_token, req);
				} catch (Exception e) {
					logger.error("QueryBuilder5.IAFT5_9", e);
					return bean;
				...
				logger.debug("\t\tMethod: IAFT5_9 Status:Retrieve End");
				return bean;
			}
		} finally {
			try {
	 ...
	 * @return the string
	 */
	public static String IAFT5_10(IAFT5Bean frm, String action, DataSource datasource, String security_token) {
		Connection conn = null;
		logger.debug("\t\tMethod: IAFT5_10 Status: Start");
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
			if (action == "retrieve") {
				try {
					...
					logger.error("QueryBuilder5.IAFT5_10", e);
					return "failure";
				}
			}
			...
			if (action == "save") {
				...
				logger.debug("\t\tMethod: IAFT5_10 Status: Save end");
				return "success";
			} else {
				logger.debug("\t\tMethod: IAFT5_10 Status: retrieve end");
				return "success";
			}
		} finally {
			try {
				...
				logger.error("QueryBuilder5.IAFT5_10", sqle);
			}
		}
	}
	...
	public static ArrayList<AggregatedSubmissionBean> getAggregatedsubmission(DataSource datasource, String urn) {
		...
		try {
			...
			logger.error("QueryBuilder5.getAggregatedsubmission", e);
			return asBeansArrayList;
		} finally {
			try {
				QueryBuilder5.closeResultSet(rs);
				...
				logger.error("QueryBuilder5.getAggregatedsubmission", sqle);
			}
		}
	}
	...
	public static String gettoken(int no ,HttpServletRequest request) {
		...
		return token;
			...
			logger.error("QueryBuilder5.gettoken", e);
		return token;
			...
			try {
				...
				logger.error("QueryBuilder5.gettoken", sqle);
			}
		}
	}
	...
	public static ArrayList<AggregatedSubmissionBean> getAggregatedsubmissiontoken(DataSource datasource, String urn) {
		...
		try {
			...
			logger.error("QueryBuilder5.getAggregatedsubmissiontoken", e);
			return asBeansArrayList;
		} finally {
			try {
				QueryBuilder5.closeResultSet(rs);
				...
				logger.error("QueryBuilder5.getAggregatedsubmissiontoken", sqle);
			}
		}
	}
	...
	public static String  updateappealstatus(DataSource datasource, String token,String status) {
		...
		try {
			...
			logger.error("QueryBuilder5.updateappealstatus", e);
			return "failure";
		} finally {
			try {
				QueryBuilder5.closeResultSet(rs);
				...
				logger.error("QueryBuilder5.updateappealstatus", sqle);
			}
		}
	}
	 ...
	 * @return the iAF t1 bean
	 */
	public static IAFT5Bean IAFT_new(IAFT5Bean frm, String action, DataSource datasource, String security_token,
			HttpServletRequest req) {
		IAFT5Bean bean = new IAFT5Bean();
		...
		try {
			...
			stmt1 = conn.prepareStatement(thissql1);
			//frm = QueryBuilder5.retrieve(frm, "retrieve", datasource, security_token, req);
			if (req.getSession().getAttribute("aggrtoken") != null) {
			...
			logger.error("QueryBuilder5.IAFT_new", e);
			return bean;
		} finally {
			try {
				QueryBuilder5.closeResultSet(rs);
				...
				logger.error("QueryBuilder5.IAFT_new", sqle);
			}
		}
    ...
    PreparedStatement stmt1=null;
		...
		{
			logger.error("QueryBuilder5.updateurn", e);
		}
		finally {
			try {
				//QueryBuilder5.closeResultSet(rs);
				...
				logger.error("QueryBuilder5.updateurn", sqle);
			}
		}

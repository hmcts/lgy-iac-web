...
public class ValidationServiceIAFT1 {
/**
* log4j logging solution
*/
static Logger logger = Logger.getLogger(ValidationServiceIAFT1.class);

public static String lsc = "";
public static boolean triggerValidation=false;

public static String IsIAFT1Page1(IAFT1Bean frm) {
...
public static String IsIAFT1Page2(IAFT1Bean frm) {
...
public static String IsIAFT1Page3(IAFT1Bean frm) {
...
+ frm.getS2i_service_year()))
errMsg = errMsg + "<br/> Invalid Date of Service of Decision";
} else
...
public static String IsIAFT1Page4(IAFT1Bean frm) {
...
public static String IsIAFT1Page5(IAFT1Bean frm) {
...
public static String IsIAFT1Page6(IAFT1Bean frm) {
...
public static String IsIAFT1Page7(IAFT1Bean frm) {
...
public static String IsIAFT1Page8(IAFT1Bean frm) {
...
public static String IsIAFT1Page9(IAFT1Bean frm) {
...
public static String IsIAFT1Page10(IAFT1Bean frm) {

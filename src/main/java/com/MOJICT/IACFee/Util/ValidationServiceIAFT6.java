...
public class ValidationServiceIAFT6 {
	/**
	 * log4j logging solution
	 */
	static Logger logger = Logger.getLogger(ValidationServiceIAFT6.class);
	public static String lsc = "";

	public static String IsIAFT6Page1(IAFT6Bean frm) {
	...
	public static String IsIAFT6Page2(IAFT6Bean frm) {
		...
		if (!Helper.isValidPostCodeIAFT6(frm.getS1f_postcode().toUpperCase()))
	...
	public static String IsIAFT6Page3(IAFT6Bean frm) {

		String errMsg = "";

		if (!Helper.isValidMandatoryRadio(frm.getS2b()))
		...
		try {
			frm.setS2f(dateconverter.convertdate(frm.getS2f_day(), frm.getS2f_month(), frm.getS2f_year()));

			if (frm.getS2f_day() != 0 && frm.getS2f_month() != 0 && frm.getS2f_year() != 0) {
				if (!Helper.isValidPastDate(frm.getS2f_day() + "/" + frm.getS2f_month() + "/" + frm.getS2f_year()))
					errMsg = errMsg + "<br/> Invalid Date of ECO Decision";
			} else
	...
	public static String IsIAFT6Page4(IAFT6Bean frm) {
	...
	public static String IsIAFT6Page6(IAFT6Bean frm) {
	...
	// In progress
	public static String IsIAFT6Page7(IAFT6Bean frm) {
		...
		if (!Helper.isValidPostCodeIAFT6(frm.getS5c_postcode().toUpperCase()))
			errMsg = errMsg + "<br/> Invalid Post code";
	...
	public static String IsIAFT6Page8(IAFT6Bean frm) {
		...
		if (!Helper.isValidPostCodeIAFT6(frm.getS6d_postcode().toUpperCase()))
			errMsg = errMsg + "<br/> Invalid Post code";

    ...
    public class ValidationServiceIAFT7 {
	/**
	* log4j logging solution
	*/
	static Logger logger = Logger.getLogger(ValidationServiceIAFT7.class);
	
	public static String lsc = "";
	public static boolean triggerValidation=false;
	
	public static String IsIAFT7Page1(IAFT7Bean frm) {
	...
	public static String IsIAFT7Page2(IAFT7Bean frm) {
	...
	if (!Helper.isValidPostCodeIAFT7(frm.getS1f_postcode().toUpperCase()))
	...
	public static String IsIAFT7Page3(IAFT7Bean frm) {
	...
	if (frm.getS2f_service_day() != 0 && frm.getS2f_service_month() != 0 && frm.getS2f_service_year() != 0) {
	if (!Helper.isValidPastDate(frm.getS2f_service_day() + "/" + frm.getS2f_service_month() + "/"
	+ frm.getS2f_service_year()))
	errMsg = errMsg + "<br/> Invalid Date you left UK following Refusal Decision";
	} else
	...
	public static String IsIAFT7Page4(IAFT7Bean frm) {
	...
	public static String IsIAFT7Page5(IAFT7Bean frm) {
	...
	public static String IsIAFT7Page6(IAFT7Bean frm) {
	...
	public static String IsIAFT7Page7(IAFT7Bean frm) {
	...
	public static String IsIAFT7Page8(IAFT7Bean frm) {
	...
	public static String IsIAFT7Page9(IAFT7Bean frm) {
	...
	public static String IsIAFT7Page10(IAFT7Bean frm) {
	...
	if (!Helper.isValidPostCodeIAFT7(frm.getS5c_postcode().toUpperCase()))
	errMsg = errMsg + "<br/> Invalid Post code";

		...
		<div id="Content">
			<div class="holder">
				...
				<div id="screening">
					...
					<div class="button">
						<a href="newlodgement?next=new">Submit another appeal</a>
					</div>
					&nbsp;
				<!-- 	<logic:equal value="0" scope="session" name="aggramount">
				 ...
				 -->
				      <div class="button">
							<a href="paymentsubmission">Proceed</a>
						</div>
						&nbsp;
				 	<br/>
					<br/>
					...
					<div class="button">
						<a href="printPDF" target="_blank">Print a copy of the appeal before you pay for it</a>
					</div>
					<br/><br/>

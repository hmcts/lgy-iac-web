						...
						<html:form action="submission2">
							<fieldset>
								...
								<div id="s6_auth" class="qBox">
									<p class="bold"><span class="bold">I, the appellant/representative, have read and understood the guidance notes for Section 6 - sponsor's details. I authorise my sponsor to make enquiries regarding my appeal on my behalf and I have explained to them the limits of what information can be given by the Tribunal</span>

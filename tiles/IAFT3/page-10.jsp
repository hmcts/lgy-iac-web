		...
		<div id="Content">
			<div class="holder">
				...
				<div class="formwrap">
					...
					<h3>Appeal to the First&ndash;Tier Tribunal (Immigration and Asylum Chamber) against your Home Office
						...
						<html:form action="submission3.do">
							<fieldset>
								...
								<div id="s5_appellant_declaration" class="qBox">
									<p><strong>If you are the appellant and are completing this form yourself, you must tick the declaration box below.</strong><span class="required">*</span></p>
									<p>
										<html:radio property="s5_rep_agreed" styleId="s5_appellant_decalaration" value="Appellant_agreed" />
								...
								<div  id="s5_declaration"  class="qBox">
									<p><span class="bold">To be completed only when signing on behalf of the person named in Section 1 of this form</span><span class="required">*</span></p>
									<p>
										<html:radio property="s5_rep_agreed" styleId="s5_rep_decalaration" value="Rep_agreed" />
							...
							<div class="submitc">
								<div class="function previous">
									<span class="tl"></span>
									<span class="tr"><span></span></span>
									<a href="previous3.do?page=9">Previous <span class="access">page</span></a>
									<span class="bl"></span>
									<span class="br"></span>
								</div>

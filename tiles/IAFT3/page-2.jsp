				...
				<html:form action="submission3.do">
					<fieldset>
						...
						<div id="s1c" class="qBox">
							...
							<span class="rCellTl"><html:text property="s1c" size="20" maxlength="20" /></span>
						</div>
						...
						<div id="s1e" class="qBox">
							...
							<span class="rCellTl">
								Male&nbsp;<html:radio property="s1e" value="Male" />&nbsp;
								Female&nbsp;<html:radio property="s1e" value="Female" />
							</span>
						</div>

						<div id="s1f" class="qBox">
							<span class="lCellTl">
									F.&nbsp;Address where you can be contacted. <span class="required">*</span>
							...
							<span class="rCellTl"><html:text property="s1f_addr1" size="35" maxlength="35" /></span>
							<span class="lCellTr">Line 2:</span>
							<span class="rCellTl"><html:text property="s1f_addr2" size="35" maxlength="35" /></span>
							<span class="lCellTr">Line 3:</span>
							<span class="rCellTl"><html:text property="s1f_addr3" size="35" maxlength="35" /></span>
...
<html:option value ="186:Zimbabwe">Zimbabwe</html:option>
							...
							<span class="rCellTl"><html:text property="s1f_postcode" size="9" maxlength="9" /></span>
						...
						<div id="s1g" class="qBox">
							...
							<span class="rCellTl">
							<html:select property="s1g" styleId="s1g">
...
<html:option value ="186:Zimbabwean">Zimbabwean</html:option>
						...
						<div id="s1h" class="qBox">
							<span class="lCellTl">H.&nbsp;If you have chosen to have an oral hearing, who will be attending? </span>
							<span class="rCellTl">
								Your representative&nbsp;<html:checkbox property="s1i_representative" styleId="s1h_rep" value="Your representative" />&nbsp;
								Witnesses&nbsp;<html:checkbox property="s1i_witness" styleId="s1h_witness" value="Witnesses" />
							</span>
						</div>

						<div id="s1i" class="qBox">
							<span class="lCellTl">I.&nbsp;Will anyone giving evidence at the hearing need an interpreter?<span class="required">*</span>
								<p><b>You should only request an interpreter if an individual who cannot speak English will be attending and giving evidence at your hearing.</b></p></span>
							<span class="rCellTl">
								No&nbsp;<html:radio property="s1j" styleId="s1i_no" value="No" onclick="clearFields('s1j_interpreter')" />&nbsp;
								Yes&nbsp;<html:radio property="s1j" styleId="s1i_yes" value="Yes" onclick="$('#s1j_interpreter').show();" />
							</span>

							<div id="s1i_interpreter">
								<p class="bold">Give details below:</p>
								<span class="lCellTr">Who:</span>
								<span class="rCellTl"><html:text property="s1j_who" styleId="s1i_who" size="35" maxlength="70" /></span>
								<span class="lCellTr">Language:</span>
								<span class="rCellTl"><html:text property="s1j_language" styleId="s1i_language" size="20" maxlength="20" /></span>
								<span class="lCellTr">Dialect:</span>
								<span class="rCellTl"><html:text property="s1j_dialect" styleId="s1i_dialect" size="20" maxlength="20" /></span>
							</div>
						</div>

						<div id="s1j" class="qBox">
							<p class="question">J.&nbsp;If anyone attending the hearing has a disability, state any special requirements they have.</p>
							<div class="tBox">
								<html:textarea property="s1k" styleId="s1j" cols="100" rows="5" />
							</div>
						</div>
					</fieldset>

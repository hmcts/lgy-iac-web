				...
				<html:form action="submission3.do">
					<fieldset>
						<div id="s2a" class="qBox">
							<span class="lCellTl">A.&nbsp;Home Office Reference Number<span class="required">*</span></span>
							<span class="rCellTl"><html:text property="s2a" styleId="s2a_homeoffice" size="14" maxlength="14" /></span>
						</div>
						...
						<div id="s2d" class="qBox">
							...
							<span class="rCellTl">
								...
								Fax/Personal Service&nbsp;<html:radio property="s2d" styleId="s2d_fax" value="Fax/Personal Service" />
						...
						<div id="s1e" class="qBox">
							<span class="lCellTl">E.&nbsp;Date you left the UK following refusal<span class="required">*</span></span>
							<span class="rCellTl">
						...
						<div id="s1f" class="qBox">
							<span class="lCellTl">G.&nbsp;Date of Service of Decision<span class="required">*</span></span>
							<span class="rCellTl">
								<html:select property="s2e_service_day">
									<html:option value="0">Day</html:option>
									<html:option value="1">01</html:option>
						...
						<div id="anonymity" class="qBox">
							<p>The tribunal will publish your name on documents relating to your case which can be viewed publically. You can apply to the tribunal for anonymity which, when granted, will result in the tribunal removing your name from all published documents.</p>

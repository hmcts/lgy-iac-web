				...
				<html:form action="submission3.do">
					<fieldset>
						<div class="qBox">
							...
							<div class="tBox"><html:textarea property="s3d_4" styleId="s3d4" cols="118" rows="15" /></div>
							<p class="charCounter">Characters left:&nbsp;<span id="s3d4_counter"></span>&nbsp;of 8000</p>
							<script type="text/javascript">$('#s3d4').CharsLeftCounter('s3d4_counter', 8000);</script>
						</div>
						...
						<div class="qBox">
							...
							<div class="tBox"><html:textarea property="s3d_5" styleId="s3d5" cols="118" rows="15" /></div>
							<p class="charCounter">Characters left:&nbsp;<span id="s3d5_counter"></span>&nbsp;of 8000</p>
							<script type="text/javascript">$('#s3d5').CharsLeftCounter('s3d5_counter', 8000);</script>
						</div>
						...
						<div class="qBox">
							...
							<div class="tBox"><html:textarea property="s3d_6" styleId="s3d6" cols="118" rows="15" /></div>
							<p class="charCounter">Characters left:&nbsp;<span id="s3d6_counter"></span>&nbsp;of 8000</p>
							<script type="text/javascript">$('#s3d6').CharsLeftCounter('s3d6_counter', 8000);</script>
						</div>
						...
						<div class="qBox">
							...
							<div class="tBox"><html:textarea property="s3d_7" styleId="s3d7" cols="118" rows="15" /></div>
							<p class="charCounter">Characters left:&nbsp;<span id="s3d7_counter"></span>&nbsp;of 8000</p>
							<script type="text/javascript">$('#s3d7').CharsLeftCounter('s3d7_counter', 8000);</script>
						</div>
					</fieldset>
					...
					<div class="submitc">
						...
						<div class="function previous">
							<span class="tl"></span>
							<span class="tr"><span></span></span>
							<a href="previous3.do?page=5">Previous <span class="access">page</span></a>
							<span class="bl"></span>
							<span class="br"></span>
						</div>

				...
				<html:form action="submission3.do">
					<fieldset>
						...
						<div class="qBox">
							...
							<div class="tBox"><html:textarea property="s3d_8" styleId="s3d8" cols="118" rows="15" /></div>
							<p class="charCounter">Characters left:&nbsp;<span id="s3d8_counter"></span>&nbsp;of 8000</p>
							<script type="text/javascript"> $('#s3d8').CharsLeftCounter('s3d8_counter', 8000);</script>
						</div>
					</fieldset>
					...
					<div class="submitc">
						...
						<div class="function previous">
							<span class="tl"></span>
							<span class="tr"><span></span></span>
							<a href="previous3.do?page=6">Previous <span class="access">page</span></a>
							<span class="bl"></span>
							<span class="br"></span>
						</div>

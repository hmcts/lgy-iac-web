				...
				<html:form action="submission3.do">
					...
					<fieldset>
						<div id="s4" class="qBox">
							...
							<span class="lCellTr"><html:checkbox property="s4_decalaration" styleId="s4_declaration" value="Agreed" /></span><span class="rCellTl"><span class="bold">Declaration</span> &ndash; I, the appellant, believe the facts stated in this appeal form are true.</span>
						</div>
					</fieldset>
					...
					<div class="submitc">
						<html:hidden property="next" value="page-10"/>
						<html:hidden property="previous" value="page-8"/>

						<div class="function previous">
							<span class="tl"></span>
							<span class="tr"><span></span></span>
							<a href="previous3.do?page=8">Previous <span class="access">page</span></a>
							<span class="bl"></span>
							<span class="br"></span>
						</div>
						<img id="progress" src="images/progress/09of10.gif" alt="*" />

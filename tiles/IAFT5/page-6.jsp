			...
			<div class="formcon">
				...
				<html:form action="submission5">
					<fieldset>
						...
						<div class="qBox">
							<p><span class="bold">EEA, EU Settlement Scheme, Frontier worker or Healthcare decision</span></p>
							<p class="question"><strong>6.</strong> If you believe that the Home Office decision is restricting your rights under the EEA right to free movement, please explain why</p>
							<p>If you believe the EU Settlement Scheme decision, EUSS family permit and travel permit, frontier worker decision or healthcare visitor decision was not in accordance with the relevant legislation/immigration rules please say why.
</p><p>If you believe the decision breaches the withdrawal agreement, EFTA separation agreement or Swiss citizen' rights agreement then please explain why.
</p>

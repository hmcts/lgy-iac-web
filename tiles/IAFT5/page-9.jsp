		...
		<div id="Content">
			<div class="holder">
				<div class="steps">
					<h2>Step 10 of 10</h2>
					<div align="right">
						<h3>Your reference : IAFT5-<bean:write name="token" scope="session"/>
						</h3>
					</div>
				</div>
				<div class="formwrap">
							...
							<fieldset>
								<div id="representative_details">
									...
									<div class="qBox">
										...
										<html:select property="s5b" styleId="s5b" >
									...
									<div class="qBox">
										...
										<span class="rCellTl">
										<html:text property="s5b_other" styleId="s5a" size="50" maxlength="50" />
										</span>
									</div>
									<div id="s5c" class="qBox">
										...
										<span class="rCellTl">
										<html:text property="s5c_addr1" styleId="s5c_addr1" size="35" maxlength="35" />
										</span>
										<span class="lCellTr" >Line 2:</span>
										<span class="rCellTl">
										<html:text property="s5c_addr2" styleId="s5c_addr2" size="35" maxlength="35" />
										</span>
										<span class="lCellTr" >Line 3:</span>
										<span class="rCellTl">
										<html:text property="s5c_addr3" styleId="s5c_addr3" size="35" maxlength="35" />
										</span>
										<span class="lCellTr" >Country:</span>
										<span class="rCellTl">
										<html:select property="s5c_addr4" styleId="s5c_addr4">
											...
											<html:option value ="6:Antigua & Barbuda">Antigua &amp; Barbuda</html:option>
										...
										<span class="rCellTl">
										<html:text property="s5c_postcode" styleId="s5c_pcode" size="9" maxlength="9" />
										</span>
									</div>
									<div class="qBox">
									...
									<div class="qBox">
										<span class="lCellTl">E.&nbsp;Telephone number</span>
										<span class="rCellTl">
										<html:text property="s5e" styleId="s5e" size="20" maxlength="20" />
										</span>
									</div>
									<div class="qBox">
										<span class="lCellTl">F.&nbsp;Mobile telephone number</span>
										<span class="rCellTl">
										<html:text property="s5f" styleId="s5f" size="20" maxlength="20" />
										</span>
									</div>
									<div class="qBox">
										<span class="lCellTl">G.&nbsp;Fax number</span>
										<span class="rCellTl">
										<html:text property="s5g" styleId="s5g" size="20" maxlength="20" />
										</span>
									</div>
									<div class="qBox">
										<span class="lCellTl">H.&nbsp;Email address</span>
										<span class="rCellTl">
										<html:text property="s5h" styleId="s5h" size="30" maxlength="50" />
										</span>
									</div>
									<div class="qBox">
										<span class="lCellTl">I.&nbsp;Legal Aid reference number</span>
										<span class="rCellTl">
										<html:text property="s5i" styleId="s5i" size="20" maxlength="20" />
										</span>
									</div>
									<div class="qBox">
										<span class="lCellTl">J.&nbsp;Legal Aid Area</span>
										<span class="rCellTl">
										<html:select property="s5j" >
									...
									<div id="s5_appellant_declaration" class="qBox">
										...
										<p>
											<html:radio property="s5_rep_agreed" styleId="s5_decalaration" value="Appellant_agreed" />
									...
									<div class="qBox">
										...
										<p><span class="required">*</span>&nbsp;(To be completed only when signing on behalf of the person named in Section 1 of this form. please tick the box below.)</p>
										<p>
											<html:radio property="s5_rep_agreed" styleId="s5_declaration" value="Rep_agreed" />
									...
									<div class="qBox">
										<h3><span class="bold">Legal Aid</span></h3>
										<p>
											<html:checkbox property="rep_sign" styleId="s5_legalaid" value="Agreed" />
											&nbsp;I, the representative certify that the appellant is in receipt of Legal Aid and is therefore exempt from paying a fee on this appeal.</p>
									</div>
									<div class="qBox">
										<h3><span class="bold">Notice to representatives</span></h3>
										<p>You must notify the First-tier Tribunal, and other parties, if you cease to represent the appellant. If the appellant changes representative, details of the new representative should be sent to the same address to which you are sending this form. Please give <span class="bold">the appellant's full name, address</span>, and <span class="bold">Post Reference number</span>.</p>
									</div>
								</div>
								<div class="qBox">
									<h3>Data Protection statement</h3>
									<p>Information, including personal details that you have provided in this form will not be used by the First-tier Tribunal, for any purpose other than the determination of your application. The information may be disclosed to other government departments and public authorities only, for related immigration or asylum purposes.</p>
								</div>
							</fieldset>
							<div class="submitc">
								<html:hidden property="next" value="finish"/>
								<html:hidden property="previous" value="page-8"/>
								<div class="function previous">
									<span class="tl"></span>
									<span class="tr"><span></span></span>
									<a href="previous5.do?page=8">Previous <span class="access">page</span></a>
									<span class="bl"></span>
									<span class="br"></span>
								</div>

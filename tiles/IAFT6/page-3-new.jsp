					...
					<fieldset>
						<div id="s2a" class="qBox">
							<span class="lCellTl">A.&nbsp;Is your refusal a points
								based system (PBS) decision? <span class="required">*</span>
							</span> <span class="rCellTl"> No&nbsp;<html:radio property="s2a"
									value="No" /> Yes&nbsp;<html:radio property="s2a" value="Yes" />
							</span>
						</div>

						<div id="s2b" class="qBox">
							<span class="lCellTl">B.&nbsp;Post Reference Number <span
								class="required">*</span></span> <span class="rCellTl"><html:text
									property="s2b" size="15" maxlength="15" /></span>
						</div>

						<div id="s2c" class="qBox">
							<span class="lCellTl">C.&nbsp;Name of decision making Post
						...
						<div id="s2e" class="qBox">
							<span class="lCellTl">F.&nbsp;Date you received your Notice of Decision <span class="required">*</span></span>
							<span class="rCellTl">
								<html:select property="s2e_day">
									<html:option value="0">Day</html:option>
									<html:option value="1">01</html:option>
						...
						<span id="s2e" class="qBox">
							<p>The tribunal will publish your name on documents relating
								to your case which can be viewed publically. You can apply to

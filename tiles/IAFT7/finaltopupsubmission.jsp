	...
	<div class="holder">
		...
		<div class="formwrap">
			...
			<div class="formcon">
				...
				<div class="edit"></div>
					<h4>Thank You</h4>
					<p>The tribunal will write to you with further information about your appeal. If you have selected and paid for an oral hearing, you will receive a notice of hearing. Please note that for appeals outside the United Kingdom, the tribunal will require evidence to be sent by the respondent to your appeal (usually an Entry Clearance Office) which means that it is likely that it will be between 11 and 19 weeks before you receive a date for your hearing.</p>
					...
					<p><strong>You need to clearly mark all documents with your submission reference number, your name and date of birth, so that the Tribunal can match these documents to your appeal. [If your submission number is not available, you should use the post reference number on your notice of decision].</strong></p>

...
<div id="Content">
	<div class="holder">
		...
		<div class="steps">
			<h2>Step 1 of 10</h2>
			<div align="right">
				<logic:present name="token"><h3>Your reference: IAFT7-<bean:write name="token" scope="session"/></h3></logic:present>
			</div>
		</div>
				...
				<html:form action="submission7">
					<fieldset>
						...
						<div id="qc" class="qBox">
							<span class="lCellTl">
								<p>C.&nbsp;Are you in receipt of legal aid funding or was the Home Office fee for the application refused (on or after the 10 October 2016) in this case waived under exceptions 4.5 or 9.4 of the 2016 Fee Regulations
							</p></span>
							<span class="rCellTl">

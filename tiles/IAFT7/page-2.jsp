						...
						<html:form action="submission7.do">
							<fieldset>
								<div id="s1a" class="qBox">
									...
									(For instance as shown on your passport)</span>
									<span class="rCellTl">
								...
								<div id="s1d" class="qBox">
									<span class="lCellTl">D.&nbsp;Date of birth (Day/Month/Year) <span class="required">*</span></span>
									<span class="rCellTl">
								...
								<div id="s1f" class="qBox">
									<span class="lCellTl">F.&nbsp;Address where you can be contacted. <span class="required">*</span></span>
									...
									<span class="lCellTr">Postcode (e.g SW170QT):<span class="required">*</span></span>
									<span class="rCellTl">
									<html:text property="s1f_postcode" size="9" maxlength="9" />
									</span>
									<span class="lCellTr">Email Address:</span>
									<span class="rCellTl">
									<html:text property="s1f_email" size="35" maxlength="254" />
									</span>
									<p class="note">Notice: If you change your address, you must notify the First-tier Tribunal immediately in writing.</p>
								</div>
								<div id="s1g" class="qBox">
									<span class="lCellTl">G.&nbsp;Prison Reference (if applicable)</span>
									<span class="rCellTl">
									<html:text property="s1g" size="20" maxlength="20" />
									</span>
								</div>
								<div id="s1h" class="qBox">
									<span class="lCellTl">H.&nbsp;Nationality <span class="required">*</span></span>
									<span class="rCellTl">
									<html:select property="s1h" styleId="s1h">
										...
										<html:option value ="139:Citizen Of St Kitts and Nevis">St Kitts &amp; Nevis, Citizen Of</html:option>
								...
								<div id="s1i" class="qBox">
									<span class="lCellTl">I.&nbsp;If you have chosen to have an oral hearing, who will be attending? </span>
									<span class="rCellTl"> Yourself&nbsp;
									<html:checkbox property="s1i_yourself" styleId="s1i_yourself" value="Yourself" />
									&nbsp;
									Your representative&nbsp;
									<html:checkbox property="s1i_representative" styleId="s1i_rep" value="Your representative" />
									&nbsp;
									Witnesses&nbsp;
									<html:checkbox property="s1i_witness" styleId="s1i_witness" value="Witnesses" />
									</span>
								</div>
								<div id="s1j" class="qBox">
									<span class="lCellTl">J.&nbsp;Will anyone giving evidence at the hearing need an interpreter? <span class="required">*</span></span>
									<span class="rCellTl"> No&nbsp;
									<html:radio property="s1j" styleId="s1j_no" value="No" />
									&nbsp;
									Yes&nbsp;
									<html:radio property="s1j" styleId="s1j_yes" value="Yes" />
									</span>
									<div id="s1j_interpreter">
										<p class="bold">Give details below:</p>
										<span class="lCellTr">Who:</span>
										<span class="rCellTl">
										<html:text property="s1j_who" styleId="s1j_who" size="35" maxlength="70" />
										</span>
										<span class="lCellTr">Language:</span>
										<span class="rCellTl">
										<html:text property="s1j_language" styleId="s1j_language" size="20" maxlength="20" />
										</span>
										<span class="lCellTr">Dialect:</span>
										<span class="rCellTl">
										<html:text property="s1j_dialect" styleId="s1j_dialect" size="20" maxlength="20" />
										</span>
									</div>
								</div>
								<div id="s1k" class="qBox">
									<p class="question">K.&nbsp;If anyone attending the hearing has a disability, state any special requirements they have.</p>
									<div class="tBox">
										<html:textarea property="s1k" styleId="s1k" cols="118" rows="5"  />
									</div>
								</div>
								<div id="currently_detained">
									<h4 id="subtitle_detained">If you are detained under the Immigration Acts or in prison serving a criminal sentence, please provide the following information:</h4>
									<div class="qBox">
										<span class="lCellTl">L.&nbsp;Are removal directions currently set for you? <span class="required">*</span></span>
										<span class="rCellTl"> No&nbsp;
										<html:radio property="s1l" value="No" />
										&nbsp;
										Yes&nbsp;
										<html:radio property="s1l" value="Yes" />
										</span>
									</div>
									<div id="removal_date">
										<div id="s1m" class="qBox">
											<span class="lCellTl">M.&nbsp;Time of removal</span>
											<span class="rCellTl">
											<html:select property="s1m_hour" styleId="s1m_hour" >
											...
											:
											<html:select property="s1m_minutes"  styleId="s1m_minutes">
												<html:option value="0" >Minutes</html:option>
											...
											AM/PM
											<html:select property="s1m_ampm"  styleId="s1m_ampm">
												<html:option value="AM">AM</html:option>
												<html:option value="PM">PM</html:option>
											</html:select>
											</span>
										</div>
										<div id="s1n" class="qBox">
											<span class="lCellTl">N.&nbsp;Date of removal</span>
											<span class="rCellTl">
											<html:select property="s1n_removal_day" styleId="s1n_day">
												<html:option value="0" >Day</html:option>
												<html:option value="1">01</html:option>
												<html:option value="2">02</html:option>
												<html:option value="3">03</html:option>
											...
											/
											<html:select property="s1n_removal_month" styleId="s1n_month">
												<html:option value="0" >Month</html:option>
												<html:option value="1">01</html:option>
												<html:option value="2">02</html:option>
												<html:option value="3">03</html:option>
											...
											/
											<html:select property="s1n_removal_year" styleId="s1n_year">
												<html:optionsCollection name="TwoYearsPlusMinus" value="yearvalue" label="yearlable" />
											</html:select>
											</span>
										</div>
									</div>
									<div class="qBox">
										<span class="lCellTl">O.&nbsp;Are you currently serving a criminal sentence? <span class="required">*</span>
										</span>
										<span class="rCellTl"> No&nbsp;
										<html:radio property="s1o" value="No" />
										&nbsp;
										Yes&nbsp;
										<html:radio property="s1o" value="Yes" />
										</span>
									</div>
									<div id="current_sentence">
										<div id="s1p" class="qBox">
											<span class="lCellTl">P.&nbsp;If yes, what date is your sentence due to end?</span>
											<span class="rCellTl">
											<html:select property="s1p_sentence_day" styleId="s1p_day">
												<html:option value="0">Day</html:option>
												<html:option value="1">01</html:option>
												<html:option value="2">02</html:option>
												<html:option value="3">03</html:option>
											...
											/
											<html:select property="s1p_sentence_month"  styleId="s1p_month">
												<html:option value="0">Month</html:option>
												<html:option value="1">01</html:option>
												<html:option value="2">02</html:option>
												<html:option value="3">03</html:option>
											...
											/
											<html:select property="s1p_sentence_year" styleId="s1p_year" >
												<html:option value="0">Year</html:option>
												<html:option value="2011">2011</html:option>
												<html:option value="2012">2012</html:option>
												<html:option value="2013">2013</html:option>
										...
										<div id="s1q" class="qBox">
											<span class="lCellTl">Q.&nbsp;What category prisoner are you?</span>
											<span class="rCellTl"> A&nbsp;
											<html:radio property="s1q" styleId="s1q_a" value="AA" />
											&nbsp;
											B&nbsp;
											<html:radio property="s1q" styleId="s1q_b" value="BB" />
											&nbsp;
											C&nbsp;
											<html:radio property="s1q" styleId="s1q_c" value="CC" />
											&nbsp;
											D&nbsp;
											<html:radio property="s1q" styleId="s1q_d" value="DD" />
											</span>
										</div>
									</div>
								</div>
							...
							<div class="submitc">
								...
								<div class="function previous">
									<span class="tl"></span>
									<span class="tr"><span></span></span>
									<a href="previous7.do?page=1">Previous <span class="access">page</span></a>
									<span class="bl"></span>
									<span class="br"></span>
								</div>
								<img id="progress" src="images/progress/02of10.gif" alt="*" />

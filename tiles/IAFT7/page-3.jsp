			...
			<div class="formcon">
				...
				<html:form action="submission7.do">
					<fieldset>
						...
						<div id="s2c" class="qBox">
							<span class="lCellTl">D.&nbsp;Home Office A-N Reference</span>
							<span class="rCellTl"><html:text property="s2hoan" styleId="s2c_cohid" size="20" maxlength="20" /></span>
						</div>
						<div id="s1h" class="qBox">
							<span class="lCellTl">E.&nbsp;Date of Application to Home Office<span class="required">*</span><br />(the date of the decision against which you are appealing)</span>
							<span class="rCellTl">
								<html:select property="s2j_service_day" styleId="s2e">
						...
						<div id="s2d" class="qBox">
							<span class="lCellTl">F.&nbsp;Method of service of decision.</span>
							<span class="rCellTl">
						...
						<div id="s1h" class="qBox">
							<span class="lCellTl">G.&nbsp;Date of Home Office Decision<span class="required">*</span><br />(the date of the decision against which you are appealing)</span>
							<span class="rCellTl">
								<html:select property="s2e_service_day" styleId="s2e">
									<html:option value="0">Day</html:option>
									<html:option value="1">01</html:option>
									<html:option value="2">02</html:option>
									<html:option value="3">03</html:option>
						...
						<div id="s1h" class="qBox">
							<span class="lCellTl">H.&nbsp;Date you left UK following Refusal Decision<span class="required">*</span><br />(the date of the decision against which you are appealing)</span>
							<span class="rCellTl">
								<html:select property="s2f_service_day" styleId="s2e">
									<html:option value="0">Day</html:option>
									<html:option value="1">01</html:option>
									<html:option value="2">02</html:option>
									<html:option value="3">03</html:option>
								 ...
								 / 
								<html:select property="s2f_service_month">
									<html:option value="0">Month</html:option>
									<html:option value="1">01</html:option>
									<html:option value="2">02</html:option>
									<html:option value="3">03</html:option>
								 ...
								 /
								 <html:select property="s2f_service_year" styleId="s1n_year">
									<html:optionsCollection name="CurrentAndTwoFormerYears" value="yearvalue" label="yearlable" />
								</html:select> 
							</span>
						</div>
						...
						<div id="s1i" class="qBox">
							<span class="lCellTl">I.&nbsp;Date you received your Notice of Decision<span class="required">*</span></span>
							<span class="rCellTl">
								<html:select property="s2i_service_day" styleId="s2e">
									<html:option value="0">Day</html:option>
									<html:option value="1">01</html:option>
									<html:option value="2">02</html:option>
									<html:option value="3">03</html:option>
						...
						<div id="s2d" class="qBox">
							<span class="lCellTl">J.&nbsp;Have you been served with a deportation decision?</span>
							<span class="rCellTl">
					...
					<div class="submitc">
						...
						<div class="function previous">
							<span class="tl"></span>
							<span class="tr"><span></span></span>
							<a href="previous7.do?page=2">Previous <span class="access">page</span></a>
							<span class="bl"></span>
							<span class="br"></span>
						</div>

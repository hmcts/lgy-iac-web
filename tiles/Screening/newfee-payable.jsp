...
<div id="Content">
	<div class="holder">
		<html:form action="NewIsFeePayable">
			<div id="screening">
				...
				<p><strong>Important: The tribunal will obtain a copy of your notice of decision and will be able to check whether your appeal is exempt.<br/> If you claim exemption where the list below does not apply to your appeal, then your appeal will be delayed whilst the <br/>tribunal writes to you requesting payment. If you do not pay, your appeal may not proceed.</strong></p>
				...
				<p><html:radio property="exemption" value="regulation19" styleId="regulation19" />&nbsp;Rule 338A of Immigration Rules (Revocation of Protection Status) if your decision is dated 10 October 2016 or after. </p>
				<p><html:radio property="exemption" value="regulation19" styleId="regulation19" />&nbsp;Regulation 23(6) of the Immigration (European Economic Area) Regulations 2016 (a decision to remove an EEA national<br /> or the family member of such a national)</p>

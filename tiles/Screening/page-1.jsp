			...
			<div class="formcon">
				...
				<html:form action="submission5.do">
					<fieldset>
						...
						<div id="qc" class="qBox">
						<p class="note">C.&nbsp;Some appeals do not have to pay a fee. Please tell us if you currently get: <span class="required">*</span></span></p>
							<span class="lCellTl">Legal Aid</span>
							<span class="rCellTl"><html:radio property="qb_lsc" value="LSC" styleId="qd_no" /></span>
							<span class="lCellTl">Asylum Support</span>
							<span class="rCellTl"><html:radio property="qb_lsc" value="Asylum Support" styleId="qd_no" /></span>
							<span class="lCellTl">Support or services under section 17* of the Children’s Act (a letter from your local council will confirm this)</span>
